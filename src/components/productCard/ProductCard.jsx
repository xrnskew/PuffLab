...
function ProductCard({ id, name, price, image, onOpen}) {
  return (
      <div onClick={onOpen} className="flex flex-col items-center gap-2.5 p-5 bg-zinc-900 border border-zinc-800 rounded-xl transition-all duration-200 hover:border-zinc-400 hover:-translate-y-0.75 hover:shadow-lg hover:shadow-white/30">
