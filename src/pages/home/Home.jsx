...
function Home({products, addToCart, removeFromCart, cart}) {
  ...
  const sortBtnCls = (mode) =>
    `bg-transparent rounded-full text-xs tracking-widest uppercase py-2 px-4.5 border-2 transition-colors duration-150 ${
      view === mode
        ? 'text-zinc-100 border-zinc-600 bg-zinc-800/60'
        : 'text-zinc-500 border-zinc-800 hover:border-2 hover:text-zinc-300 hover:border-zinc-600'
    }`;
